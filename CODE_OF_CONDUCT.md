...
We want a productive, happy and agile community that can welcome new ideas, improve every processes, and foster collaboration between groups with very different needs, interests and skills.
...
We expect participants in the project to resolve disagreements constructively. When they cannot, we escalate the matter to designated leaders to arbitrate and provide clarity and direction.
...
Responsibility for the project starts with the core maintainers, who delegate specific responsibilities and the corresponding authority to a series of teams and individuals. The core maintainers will arbitrate in any dispute.
...
Nominations to teams are at the discretion of the core maintainers, however the core maintainers will seek the input of the community before confirming appointments.
...
We recognise that the project works better when we trust the teams closest to a problem to make the decision for the project. If we learn of a decision that we disagree with, we can engage the relevant team to find common ground. Ultimately, if a decision has been taken by the people responsible for it, and is supported by the core maintainers, it will stand. None of us expects to agree with every decision, and we value highly the willingness to stand by the project and help it deliver even on the occasions when we ourselves may prefer a different route.
...
*The Butterfly Code of Conduct is licensed under the [Creative Commons Attribution-Share Alike 3.0](https://creativecommons.org/licenses/by-sa/3.0/) license and [derived from the Ubuntu Code of Conduct](https://ubuntu.com/community/code-of-conduct).*
